...
insert color_graph values (5, 11, 4) --紅 粉紅 3
insert color_graph values (5, 12, 0) --紅 青 0
...
insert color_graph values (6, 11, 4) --橘 粉紅 3
insert color_graph values (6, 12, 0) --橘 青 0
...
insert color_graph values (7, 11, 4) --黃 粉紅 4
insert color_graph values (7, 12, 4) --黃 青 2
...
insert color_graph values (8, 11, 4) --綠 粉紅 0
insert color_graph values (8, 12, 3) --綠 青 3
...
insert color_graph values (2, 11, 4) --藍 粉紅 2.5
insert color_graph values (2, 12, 3.5) --藍 青 3.5
...
insert color_graph values (9, 11, 4) --紫 粉紅 3.5
insert color_graph values (9, 12, 2) --紫 青 2
...
insert color_graph values (3, 11, 4) --黑 粉紅 4
insert color_graph values (3, 12, 4) --黑 青 3.5
...
insert color_graph values (10, 11, 4) --灰 粉紅 3
insert color_graph values (10, 12, 5) --灰 青 5
...
insert color_graph values (4, 11, 4) --白 粉紅 4
insert color_graph values (4,12,4.5) --白 青 4.5

insert color_graph values (11,5,3.5) --粉紅 紅 3.5
insert color_graph values (11,6,2) --粉紅 橘 2
insert color_graph values (11,7,0) --粉紅 黃 0
insert color_graph values (11,8,0) --粉紅 綠 0
insert color_graph values (11,2,0) --粉紅 藍 0
insert color_graph values (11,9,3) --粉紅 紫 3
insert color_graph values (11,3,5) --粉紅 黑 5
insert color_graph values (11,10,4.5) --粉紅 灰 4.5
insert color_graph values (11,4,3) --粉紅 白 3
insert color_graph values (11,11,2) --粉紅 粉紅 2
insert color_graph values (11,12,0) --粉紅 青 0

insert color_graph values (12,5,3.5) --青 紅 0
insert color_graph values (12,6,2) --青 橘 0
insert color_graph values (12,7,0) --青 黃 0
insert color_graph values (12,8,0) --青 綠 1
insert color_graph values (12,2,0) --青 藍 2
insert color_graph values (12,9,3) --青 紫 0
insert color_graph values (12,3,5) --青 黑 5
